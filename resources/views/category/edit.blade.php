...
<h1 style="text-align: center">Edit Category Page</h1>
...
<div class="card-body">
    <form action="{{route('categories.update', $category->id)}}" method="post">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{  $category->categoryName }}">
                {{-- @if ($errors->has('name'))
